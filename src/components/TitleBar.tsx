...
export function TitleBar({ toggleSidebar }: { toggleSidebar: () => void }) {
    ...
    return (
        <div className="h-10 bg-background/50 backdrop-blur-md flex items-center justify-between px-3 select-none border-b border-border/50 fixed top-0 left-0 right-0 z-50 transition-colors duration-300">
